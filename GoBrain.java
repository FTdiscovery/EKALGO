...
/*
 * This is our neural network that we will use to predict expert moves. 와...
 */

public class GoBrain {
	...
	public double[][] returnSynapse0() {
		return synapse0;
	}
	public double[][] returnSynapse1() {
		return synapse1;
	}
	public double[][] returnSynapse2() {
		return synapse2;
	}
	public double[][] returnSynapse3() {
		return synapse3;
	}
	public double[][] returnSynapse4() {
		return synapse4;
	}
	public double[][] returnSynapse5() {
		return synapse5;
	}
	public double[][] returnSynapse6() {
		return synapse6;
	}
	public double[][] returnSynapse7() {
		return synapse7;
	}
	public double[][] returnSynapse8() {
		return synapse8;
	}
	public double[][] returnFinalSynapse() {
		return finalSynapse;
	}
	
	public GoBrain(double[][] a, double[][] b, int d, double e) {
		INPUT_VALUES=a;
		OUTPUT_VALUES=b;
		nodesPerLayer=d;
